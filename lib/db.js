...
function buildSeed() {
  ...
  return {
    ...
    maintenanceCards: [
      { id: 'mc1', vehicleId: 'v1', plate: 'أ ب ج 1234', driverDuringMaintenance: 'أحمد سالم', maintenanceDate: '2026-04-10', maintenanceType: 'زيت', description: 'تغيير زيت المحرك مع فلتر الزيت', totalCost: 420, serviceProvider: 'ورشة الرياض المتحدة', status: 'completed', notes: '', createdAt: now },
      { id: 'mc2', vehicleId: 'v3', plate: 'ز ح ط 9012', driverDuringMaintenance: 'خالد حسن', maintenanceDate: '2026-04-18', maintenanceType: 'فرامل', description: 'تبديل أقمشة الفرامل الأمامية', totalCost: 680, serviceProvider: 'مركز الدمام للصيانة', status: 'in_progress', notes: 'بانتظار فحص نهائي', createdAt: now },
    ],
    appointments: [
