...
function buildSeed() {
  ...
  return {
    ...
    vehicles: [
      { id: 'v1', name: 'تويوتا لاندكروزر', plate: 'أ ب ج 1234', city: 'الرياض',   driver: 'أحمد سالم',  status: 'active',      location: 'الرياض',   lat: 24.7136, lng: 46.6753, km: 45200, fuelLevel: 78, year: 2022, color: 'أبيض', createdAt: now },
      { id: 'v2', name: 'فورد F-150',        plate: 'د هـ و 5678', city: 'جدة',     driver: 'سارة علي',   status: 'charging',    location: 'جدة',      lat: 21.4858, lng: 39.1925, km: 31500, fuelLevel: 45, year: 2023, color: 'أسود', createdAt: now },
      { id: 'v3', name: 'شيفروليه سيلفرادو', plate: 'ز ح ط 9012', city: 'الدمام',  driver: 'خالد حسن',   status: 'maintenance', location: 'الدمام',   lat: 26.4207, lng: 50.0888, km: 62100, fuelLevel: 20, year: 2021, color: 'رمادي', createdAt: now },
      { id: 'v4', name: 'تويوتا هايلوكس',   plate: 'ي ك ل 3456', city: 'المدينة', driver: 'منى فهد',    status: 'active',      location: 'المدينة',  lat: 24.5247, lng: 39.5692, km: 28900, fuelLevel: 92, year: 2023, color: 'أبيض', createdAt: now },
      { id: 'v5', name: 'نيسان باترول',      plate: 'م ن س 7890', city: 'مكة',     driver: 'علي ناصر',   status: 'active',      location: 'مكة',      lat: 21.3891, lng: 39.8579, km: 19400, fuelLevel: 65, year: 2024, color: 'أزرق', createdAt: now },
      { id: 'v6', name: 'مرسيدس سبرينتر',   plate: 'ع غ ف 1122', city: 'أبها',    driver: 'هند راشد',   status: 'charging',    location: 'أبها',     lat: 18.2164, lng: 42.5053, km: 54300, fuelLevel: 30, year: 2022, color: 'أبيض', createdAt: now },
      { id: 'v7', name: 'كيا سورينتو',       plate: 'ق ر س 3311', city: 'تبوك',    driver: 'فيصل عمر',   status: 'active',      location: 'تبوك',     lat: 28.3835, lng: 36.5662, km: 12700, fuelLevel: 88, year: 2024, color: 'أحمر', createdAt: now },
      { id: 'v8', name: 'هيوندا توسون',      plate: 'ت ث ج 7744', city: 'القصيم',  driver: 'نورة سعد',   status: 'active',      location: 'القصيم',   lat: 26.3260, lng: 43.9750, km: 8900,  fuelLevel: 71, year: 2025, color: 'أخضر', createdAt: now },
    ],
    drivers: [
