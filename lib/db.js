...
function buildSeed() {
  ...
  return {
    ...
    employees: [
      { id: 'e1', name: 'أحمد سالم',  nationalId: '1012345678', phone: '0501234567', department: 'العمليات',     jobTitle: 'سائق',          email: 'ahmed@fna.sa',  status: 'active', vehicleId: 'v1', quickPin: '1357', createdAt: now },
      { id: 'e2', name: 'سارة علي',   nationalId: '1098765432', phone: '0509876543', department: 'اللوجستيات',   jobTitle: 'سائقة',         email: 'sara@fna.sa',   status: 'active', vehicleId: 'v2', quickPin: '2468', createdAt: now },
      { id: 'e3', name: 'خالد حسن',  nationalId: '1056781234', phone: '0505551234', department: 'الصيانة',      jobTitle: 'فني',           email: 'khalid@fna.sa', status: 'active', vehicleId: 'v3', quickPin: '1597', createdAt: now },
      { id: 'e4', name: 'منى فهد',   nationalId: '1023344556', phone: '0502223344', department: 'العمليات',     jobTitle: 'سائقة',         email: 'mona@fna.sa',   status: 'active', vehicleId: 'v4', quickPin: '2684', createdAt: now },
      { id: 'e5', name: 'علي ناصر',  nationalId: '1077889900', phone: '0507778899', department: 'الإدارة',      jobTitle: 'مشرف عمليات',  email: 'ali@fna.sa',    status: 'active', vehicleId: 'v5', quickPin: '3141', createdAt: now },
      { id: 'e6', name: 'هند راشد',  nationalId: '1033445566', phone: '0503334455', department: 'اللوجستيات',   jobTitle: 'سائقة',         email: 'hind@fna.sa',   status: 'active', vehicleId: 'v6', quickPin: '2718', createdAt: now },
    ],
    alerts: [
